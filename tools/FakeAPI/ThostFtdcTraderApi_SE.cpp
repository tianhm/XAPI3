...
public:
   ...
   ///@retrun (smk/smi/sms)://IP:PORT
	virtual char* GetSMCertAddr() { return 0; }
	...
	virtual void GetFrontInfo(CThostFtdcFrontInfoField* pFrontInfo) { return; }
	...
	virtual int RegisterWechatUserSystemInfo(CThostFtdcWechatUserSystemInfoField* pUserSystemInfo) { return 0; }
	///上报用户终端信息，用于中继服务器操作员登录模式.用于微信小程序等应用上报信息.
	virtual int SubmitWechatUserSystemInfo(CThostFtdcWechatUserSystemInfoField* pUserSystemInfo) { return 0; }
	...
	///请求查询用户会话
	virtual int ReqQryUserSession(CThostFtdcQryUserSessionField* pQryUserSession, int nRequestID) { return 0; }
	...
	///
	virtual int ReqUserLoginSM(CThostFtdcReqUserLoginSMField* pReqUserLoginSM, int nRequestID) { return 0; }
	...
	///投资者申报费阶梯收取记录查询
	virtual int ReqQryInvestorInfoCommRec(CThostFtdcQryInvestorInfoCommRecField* pQryInvestorInfoCommRec, int nRequestID) { return 0; }

	///组合腿信息查询
	virtual int ReqQryCombLeg(CThostFtdcQryCombLegField* pQryCombLeg, int nRequestID) { return 0; }

	///对冲设置请求
	virtual int ReqOffsetSetting(CThostFtdcInputOffsetSettingField* pInputOffsetSetting, int nRequestID) { return 0; }

	///对冲设置撤销请求
	virtual int ReqCancelOffsetSetting(CThostFtdcInputOffsetSettingField* pInputOffsetSetting, int nRequestID) { return 0; }

	///投资者对冲设置查询
	virtual int ReqQryOffsetSetting(CThostFtdcQryOffsetSettingField* pQryOffsetSetting, int nRequestID) { return 0; }

	///申请短信验证码请求
	virtual int ReqGenSMSCode(CThostFtdcReqGenSMSCodeField* pReqGenSMSCode, int nRequestID) { return 0; }

	///套利确认请求
	virtual int ReqSpdApply(CThostFtdcInputSpdApplyField* pInputSpdApply, int nRequestID) { return 0; }

	///套利确认撤销请求
	virtual int ReqSpdApplyAction(CThostFtdcInputSpdApplyActionField* pInputSpdApplyAction, int nRequestID) { return 0; }

	///套利确认查询请求
	virtual int ReqQrySpdApply(CThostFtdcQrySpdApplyField* pQrySpdApply, int nRequestID) { return 0; }

	///套保确认请求
	virtual int ReqHedgeCfm(CThostFtdcInputHedgeCfmField* pInputHedgeCfm, int nRequestID) { return 0; }

	///套保确认撤销请求
	virtual int ReqHedgeCfmAction(CThostFtdcInputHedgeCfmActionField* pInputHedgeCfmAction, int nRequestID) { return 0; }

	///套保确认查询请求
	virtual int ReqQryHedgeCfm(CThostFtdcQryHedgeCfmField* pQryHedgeCfm, int nRequestID) { return 0; }

private:
	CThostFtdcTraderSpi* m_pSpi;
};

CThostFtdcTraderApi* CThostFtdcTraderApi::CreateFtdcTraderApi(const char* pszFlowPath, bool bIsProductionMode)
{
